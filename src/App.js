...
import { AuthProvider } from './pages/account/Auth';
        ...
        <AuthProvider>
            <Router>
                ...
                <Switch>
                    ...
                    <PrivateRoute path={`${process.env.PUBLIC_URL + "/course-grid"}`} component={CourseGrid} />
                    {/* <Route path={`${process.env.PUBLIC_URL + "/course-list"}`} component={CourseList} /> */}
                    <PrivateRoute path={`${process.env.PUBLIC_URL + "/course-details/:course"}`} component={CourseDetails} />

                        ...
                        <Col md="0" sm="12">
                            <div className="mb-topbar d-flex justify-content-between">
                                <div className="topbar-item">
                                    <p><i className="las la-phone"></i>+61 (411) 135 059</p>
                                </div>
                                <div className="topbar-item">
                                    <ul className="list-unstyled list-inline">
                                        {currentUser && <li className="list-inline-item" onClick={() => { firebase.auth().signOut() }} >Log Out</li>}
                                        {!currentUser && <li className="list-inline-item"><Link to={process.env.PUBLIC_URL + "/login"}>Log In</Link></li>}
                                        {!currentUser && <li className="list-inline-item">/</li>}
                                        {!currentUser && <li className="list-inline-item"><Link to={process.env.PUBLIC_URL + "/registration"}>Register</Link></li>}
                                    </ul>
                                </div>
                            </div>
                            <div className="mb-logo-area d-flex justify-content-between">
                                <div className="mb-logo-box d-flex">
                                    ...
                                    <div className="mb-logo">
                                        <Link to={process.env.PUBLIC_URL + "/"}><img src={process.env.PUBLIC_URL + "/assets/images/robotatmobile.png"} alt="" /></Link>
                                    </div>
                                </div>
            ...
            {/* <section className="mb-sidebar " id="mb-sidebar-body">
                ...
                <div className="mb-sidebar-menu">
                    ...
                    {/* <div className="mb-menu-item">
                        ...
                        <div className="mb-menu-content show">
                            <ul className="list-unstyled">
                                <li><Link to={process.env.PUBLIC_URL + "/course-grid"}>All Courses</Link></li> */}
                    ...
                    {/* <div className="mb-menu-item">
                        ...
                        <div className="mb-menu-content">
                            <ul className="list-unstyled">
                                <li><Link to={process.env.PUBLIC_URL + "/events"}>All Events</Link></li>
                    ...
                    <div className="mb-menu-item">
                        ...
                        <div className="mb-menu-content">
                            <ul className="list-unstyled">
                                <li><Link to={process.env.PUBLIC_URL + "/blog-classic"}>All Blogs </Link></li>
